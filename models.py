...
combo_custom_tricks = db.Table('combo_custom_tricks',
                               db.Column('combo_id', db.Integer, db.ForeignKey('combo.id'), primary_key=True),
                               db.Column('custom_trick_id', db.Integer, db.ForeignKey('custom_trick.id'), primary_key=True)
                               )
...
class Combo(db.Model):
    ...
    # Many-to-many relationship with custom tricks
    custom_moves = db.relationship('CustomTrick', secondary=combo_custom_tricks, backref='combos')
